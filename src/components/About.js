...
const About = () => {
    const [state] = React.useState({ heading: 'Who we are?', text: 'Avo specialises in providing an authorised scrap car recycling service. We are the largest scrap car recycling network in the UK! Cars dont just get crushed into a cube! When a car arrives at the scrap car recycling centre there iss lots that goes into depolluting and recycling it. Fluids such as fuel, brake fluid, even windscreen washer fluids have to be safely removed from the vehicle, ensuring that no excess chemicals leak into the environment. Airbags have to be securely detonated.' });
    const [sections] = React.useState([
        {
            ...
            </svg>, heading: 'Car Cycling', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'
        },
        {
            ...
            </svg>, heading: 'Pimp My Car', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'
        },
        {
            ...
            </svg>, heading: 'Scrap Removal', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'
        }
    ]);
    return (
        <div className="about">
